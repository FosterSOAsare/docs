		...
		<div className="absolute right-8 bottom-8 flex items-center justify-center gap-3 flex-col py-4 px-2" ref={buttonRef}>
			{show && (
				<>
					...
					<div className="rounded-full bg-white overflow-hidden p-3 h-12 w-12 shadow-custom flex items-center hover:cursor-pointer justify-center " title="Create new document">
